...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DDgmilGp.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BEQnLJVo.mjs").then((n2) => n2.k),
    import("./start-CsG_aLmf.mjs"),
...
export {
  ...
  encodePathLikeUrl as o,
  escapeHtml as p,
  exactPathTest as q,
  executeRewriteInput as r,
  executeRewriteOutput as s,
  findFlatMatch as t,
  findRouteMatch as u,
  findSingleMatch as v,
  functionalUpdate as w,
  getAssetCrossOrigin as x,
  getDefaultExportFromCjs as y,
  getScriptPreloadAttrs as z
};
