import { u as useNavigate, c as createLucideIcon, o as useQueryClient, d as notifyManager, n as noop, e as environmentManager, l as shouldThrowError, a as Subscribable, p as pendingThenable, h as resolveQueryBoolean, s as shallowEqualObjects, j as resolveStaleTime, i as isValidTimeout, t as timeUntilStale, m as timeoutManager, b as focusManager, f as fetchState, g as replaceData } from "./router-BEQnLJVo.mjs";
...
function CitySearch({ initial = "", autoFocus = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      role: "search",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "ml-2 h-5 w-5 text-muted-foreground", "aria-hidden": true }),
