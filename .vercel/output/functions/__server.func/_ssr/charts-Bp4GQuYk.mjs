import { L as jsxRuntimeExports, U as reactExports, y as getDefaultExportFromCjs, Y as requireReact, a as React$1, f as commonjsGlobal } from "./server-B2Kjs41y.mjs";
import { r as reactDomExports } from "./router-BEQnLJVo.mjs";
  ...
  function get2(object2, path, defaultValue) {
    ...
    switch (typeof path) {
      case "string": {
        ...
        if (result === void 0) if (require_isDeepKey.isDeepKey(path)) return get2(object2, require_toPath.toPath(path), defaultValue);
...
function requireProperty() {
  ...
  function property$1(path) {
    return function(object2) {
      return require_get.get(object2, path);
    };
  }
...
function requireIsBuffer() {
  ...
  function isBuffer$1(x2) {
    return typeof require_globalThis.globalThis_.Buffer !== "undefined" && require_globalThis.globalThis_.Buffer.isBuffer(x2);
  }
...
function requireCloneDeepWith$1() {
  ...
  function isCloneableObject(object2) {
    switch (require_getTag.getTag(object2)) {
...
function requireCloneDeepWith() {
  ...
  function cloneDeepWith$12(obj, customizer) {
    return require_cloneDeepWith.cloneDeepWith(obj, (value, key, object2, stack) => {
      ...
      if (require_getTag.getTag(obj) === "[object Object]" && typeof obj.constructor !== "function") {
        ...
        require_cloneDeepWith.copyProperties(result, obj, object2, stack);
        return result;
      }
...
function requireHas() {
  ...
  function has2(object2, path) {
    ...
    else if (typeof path === "string" && require_isDeepKey.isDeepKey(path) && object2?.[path] == null) resolvedPath = require_toPath.toPath(path);
    ...
    for (let i = 0; i < resolvedPath.length; i++) {
      ...
      if (current2 == null || !Object.hasOwn(current2, key)) {
        if (!((Array.isArray(current2) || require_isArguments.isArguments(current2)) && require_isIndex.isIndex(key) && key < current2.length)) return false;
      }
...
function requireUniqBy$1() {
  ...
  function uniqBy2(array2, iteratee$1 = require_identity.identity) {
    if (!require_isArrayLikeObject.isArrayLikeObject(array2)) return [];
    return require_uniqBy.uniqBy(Array.from(array2), require_ary.ary(require_iteratee.iteratee(iteratee$1), 1));
  }
...
function requireIsIterateeCall() {
  ...
  function isIterateeCall$1(value, index, object2) {
    if (!require_isObject.isObject(object2)) return false;
    if (typeof index === "number" && require_isArrayLike.isArrayLike(object2) && require_isIndex.isIndex(index) && index < object2.length || typeof index === "string" && index in object2) return require_isEqualsSameValueZero.isEqualsSameValueZero(object2[index], value);
    return false;
  }
...
function requireCompareValues() {
  ...
  const compareValues$1 = (a2, b, order) => {
    if (a2 !== b) {
  ...
  function orderBy$1(collection, criteria, orders, guard) {
    ...
    return collection.map((item) => ({
      ...
      for (let i = 0; i < preparedCriteria.length; i++) {
        const comparedResult = require_compareValues.compareValues(a2.criteria[i], b.criteria[i], orders[i]);
...
var _excluded$i = ["radius"], _excluded2$a = ["radius"];
...
var Rectangle = (rectangleProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), {
      radius: _2
    } = _svgPropertiesAndEven2, otherPathProps2 = _objectWithoutProperties$i(_svgPropertiesAndEven2, _excluded2$a);
...
var _excluded$g = ["x", "y", "lineHeight", "capHeight", "fill", "scaleToFit", "textAnchor", "verticalAnchor"], _excluded2$9 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$h() {
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  ...
  var {
    ...
    className,
    breakAll
  } = props, textProps = _objectWithoutProperties$g(props, _excluded2$9);
...
var _excluded$f = ["labelRef"], _excluded2$8 = ["content"];
...
function Label(outerProps) {
  ...
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$f(propsWithViewBox, _excluded2$8);
...
var _excluded$e = ["valueAccessor"], _excluded2$7 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$f() {
...
function requireIsPlainObject$1() {
  ...
  function isPlainObject2(object2) {
    ...
    if (Object.getPrototypeOf(object2) === null) return true;
    if (Object.prototype.toString.call(object2) !== "[object Object]") {
      const tag = object2[Symbol.toStringTag];
      if (tag == null) return false;
      if (!Object.getOwnPropertyDescriptor(object2, Symbol.toStringTag)?.writable) return false;
...
function AxisLine(axisLineProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement("line", _extends$b({}, props, {
...
function TickItem(props) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    tickItem = /* @__PURE__ */ reactExports.createElement(Text, _extends$b({}, tickProps, {
      className
    }), value);
  }
  return tickItem;
...
var Ticks = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  var axisProps2 = svgPropertiesNoEvents(getTicksConfig);
  var customTickProps = svgPropertiesNoEventsFromUnknown(tick);
  var textAnchor = isValidTextAnchor(axisProps2.textAnchor) ? axisProps2.textAnchor : getTickTextAnchor(orientation, mirror);
  var verticalAnchor = getTickVerticalAnchor(orientation, mirror);
  var tickLinePropsObject = {};
  if (typeof tickLine === "object") {
    tickLinePropsObject = tickLine;
  }
  var tickLineProps = _objectSpread$8(_objectSpread$8({}, axisProps2), {}, {
    fill: "none"
  }, tickLinePropsObject);
  ...
  var tickLines = tickLineCoords.map((_ref2) => {
    ...
    }, tickLine && /* @__PURE__ */ reactExports.createElement("line", _extends$b({}, tickLineProps, lineCoord, {
  ...
  var tickLabels = tickLineCoords.map((_ref3, i) => {
    ...
    var tickProps = _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({
      ...
      angle: (_ref4 = (_tickTextProps$angle = tickTextProps === null || tickTextProps === void 0 ? void 0 : tickTextProps.angle) !== null && _tickTextProps$angle !== void 0 ? _tickTextProps$angle : axisProps2.angle) !== null && _ref4 !== void 0 ? _ref4 : 0
    });
...
var CartesianAxis = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(CartesianAxisComponent, _extends$b({}, props, {
    ref
  }));
});
CartesianAxis.displayName = "CartesianAxis";
var _excluded$a = ["x1", "y1", "x2", "y2", "key"], _excluded2$6 = ["offset"], _excluded3$4 = ["xAxisId", "yAxisId"], _excluded4$1 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    var {
      ...
      y2,
      key
    } = lineItemProps, others = _objectWithoutProperties$a(lineItemProps, _excluded$a);
    var _ref22 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(others)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      offset: __
    } = _ref22, restOfFilteredProps = _objectWithoutProperties$a(_ref22, _excluded2$6);
    lineItem = /* @__PURE__ */ reactExports.createElement("line", _extends$a({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$a(props, _excluded3$4);
...
function VerticalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$a(props, _excluded4$1);
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ reactExports.createElement(HorizontalStripes, _extends$a({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ reactExports.createElement(VerticalStripes, _extends$a({}, propsIncludingDefaults, {
    verticalPoints
  })), /* @__PURE__ */ reactExports.createElement(HorizontalGridLines, _extends$a({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ reactExports.createElement(VerticalGridLines, _extends$a({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
...
var _excluded$8 = ["id"], _excluded2$5 = ["type", "layout", "connectNulls", "needClip", "shape"], _excluded3$3 = ["activeDot", "animateNewValues", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "hide", "isAnimationActive", "label", "legendType", "xAxisId", "yAxisId", "id"];
function _extends$9() {
...
function StaticCurve(_ref4) {
  ...
  var {
    ...
    needClip,
    shape
  } = props, others = _objectWithoutProperties$8(props, _excluded2$5);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ reactExports.createElement(Shape, _extends$9({
    shapeType: "curve",
    option: shape
  }, curveProps, {
    pathRef
...
function LineImpl(props) {
  var _resolveDefaultProps = resolveDefaultProps(props, defaultLineProps), {
    ...
    yAxisId,
    id
  } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$8(_resolveDefaultProps, _excluded3$3);
  var {
    needClip
  } = useNeedsClip(xAxisId, yAxisId);
  var plotArea = usePlotArea();
  ...
  return /* @__PURE__ */ reactExports.createElement(LineWithState, _extends$9({}, everythingElse, {
    id,
    connectNulls,
    dot,
    activeDot,
...
function LineFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    hide: props.hide,
    isPanorama
  }), /* @__PURE__ */ reactExports.createElement(LineImpl, _extends$9({}, props, {
    id
  }))));
}
...
var _excluded$7 = ["id"], _excluded2$4 = ["activeDot", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "fill", "fillOpacity", "hide", "isAnimationActive", "legendType", "stroke", "xAxisId", "yAxisId"];
function _extends$8() {
...
function StaticArea(_ref4) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ reactExports.createElement(Layer, {
    clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0
  }, /* @__PURE__ */ reactExports.createElement(Curve, _extends$8({}, propsWithEvents, {
    id,
    points,
    connectNulls,
    type,
  ...
  })), stroke !== "none" && /* @__PURE__ */ reactExports.createElement(Curve, _extends$8({}, allOtherProps, {
    ...
    fill: "none",
    points
  })), stroke !== "none" && isRange && Array.isArray(baseLine) && /* @__PURE__ */ reactExports.createElement(Curve, _extends$8({}, allOtherProps, {
    className: "recharts-area-curve",
    layout,
    type,
    connectNulls,
...
function AreaImpl(props) {
  ...
  var {
    ...
    xAxisId,
    yAxisId
  } = props, everythingElse = _objectWithoutProperties$7(props, _excluded2$4);
  var layout = useChartLayout();
  var chartName = useChartName();
  var {
    needClip
...
function TrendArea({ data, dataKey = "aqi", xKey = "day", color: color2 = "var(--color-primary)", height = 200 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data, margin: { top: 10, right: 8, left: -16, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: `g-${dataKey}`, x1: "0", y1: "0", x2: "0", y2: "1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: xKey, ...axisProps }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { ...axisProps, width: 36 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { stroke: color2, strokeOpacity: 0.3 } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey, stroke: color2, strokeWidth: 2, fill: `url(#g-${dataKey})` })
  ] }) });
}
function MiniSpark({ data, color: color2 = "var(--color-primary)" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 56, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data, margin: { top: 4, right: 0, left: 0, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "v", stroke: color2, strokeWidth: 1.75, dot: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle, labelFormatter: (l) => `${l}` })
  ] }) });
}
function CompareBars({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 10, right: 8, left: -16, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "var(--color-border)", strokeDasharray: "2 4", vertical: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", ...axisProps }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { ...axisProps, width: 36 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "previous", name: "Last year", fill: "var(--color-chart-5)", radius: [3, 3, 0, 0] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "current", name: "This year", fill: "var(--color-primary)", radius: [3, 3, 0, 0] })
  ] }) });
}
export {
  CompareBars as C,
