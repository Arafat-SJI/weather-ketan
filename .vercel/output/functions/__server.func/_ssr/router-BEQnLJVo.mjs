import { g as compileDecodeCharMap, j as createLRUCache, a3 as trimPath, a0 as rewriteBasepath, h as composeRewrites, T as processRouteTree, S as processRouteMasks, $ as resolvePath, e as cleanPath, a5 as trimPathRight, i as createControlledPromise, Q as parseHref, r as executeRewriteInput, E as isDangerousProtocol, V as redirect, I as isRedirect, G as isNotFound, v as findSingleMatch, m as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, B as interpolatePath, P as nullReplaceEqualDeep, X as replaceEqualDeep$1, M as last, l as decodePath, t as findFlatMatch, w as functionalUpdate$1, u as findRouteMatch, H as isPromise, C as invariant, a1 as rootRouteId, a7 as useRouter, L as jsxRuntimeExports, O as Outlet, A as hasKeys, s as executeRewriteOutput, c as arraysEqual, U as reactExports, R as React, q as exactPathTest, W as removeTrailingSlash, F as isModuleNotFoundError, J as isServer$1, n as dummyMatchContext, N as matchContext, p as escapeHtml, x as getAssetCrossOrigin, z as getScriptPreloadAttrs, b as appendUniqueUserTags, a6 as useHydrated, a4 as trimPathLeft, K as joinPaths, _ as resolveManifestCssLink, o as encodePathLikeUrl, Z as requireReactDom } from "./server-B2Kjs41y.mjs";
...
const appCss = "/assets/styles-BE_1S1sk.css";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-primary/15 ring-1 ring-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wind, { className: "h-5 w-5 text-primary", "aria-hidden": true }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-lg font-semibold tracking-tight", children: [
          "Atmos",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Primary", className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-1", children: nav.map(({ to, label, icon: Icon2 }) => {
        const active = pathname === to;
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
            className: `inline-flex items-center gap-2 rounded-md px-3 py-2 text-sm transition-colors ${active ? "bg-surface text-foreground" : "text-muted-foreground hover:bg-surface hover:text-foreground"}`,
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground hidden sm:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-full bg-[color:var(--aqi-good)] animate-pulse" }),
        "Live data"
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Mobile", className: "md:hidden border-t border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex justify-around px-2 py-1", children: nav.map(({ to, label, icon: Icon2 }) => {
      const active = pathname === to;
      return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: `flex flex-col items-center gap-0.5 rounded-md px-2 py-1.5 text-[10px] ${active ? "text-primary" : "text-muted-foreground"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4", "aria-hidden": true }),
        label
      ] }) }, to);
    }) }) })
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 mt-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-8 grid gap-6 md:grid-cols-3 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-semibold", children: "Atmos." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Real-time environmental monitoring for a healthier planet." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium mb-2", children: "Data sources" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Demo data. In production, integrate WAQI, OpenWeather, and local monitoring stations." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium mb-2", children: "A note on accessibility" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "All charts include text alternatives and color is paired with labels." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/60 py-4 text-center text-xs text-muted-foreground", children: [
      ...
      " Atmos. Built with care for clean air."
    ] })
  ] });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[60vh] items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "The breeze blew this page away." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[60vh] items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        router2.invalidate();
        reset();
      }, className: "inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90", children: "Try again" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "inline-flex items-center rounded-md border border-input px-4 py-2 text-sm font-medium hover:bg-accent", children: "Go home" })
    ] })
  ] }) });
}
const Route$8 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Atmos — Real-time air quality & environmental dashboard" },
      { name: "description", content: "Track AQI, pollutants, weather and environmental insights for any city worldwide." },
      { name: "theme-color", content: "#0c2340" },
      { property: "og:title", content: "Atmos — Real-time air quality & environmental dashboard" },
      { property: "og:description", content: "Track AQI, pollutants, weather and environmental insights for any city worldwide." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Atmos — Real-time air quality & environmental dashboard" },
      { name: "twitter:description", content: "Track AQI, pollutants, weather and environmental insights for any city worldwide." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/2710b645-7f5c-4a60-bbfd-bbf08457734c" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/2710b645-7f5c-4a60-bbfd-bbf08457734c" }
    ],
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteFooter, {})
  ] }) });
}
const $$splitComponentImporter$7 = () => import("./settings-OgcT9k5W.mjs");
const Route$7 = createFileRoute("/settings")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Connect your OpenWeather API key to enable live air quality data."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./map-DtJt5gmd.mjs");
const Route$6 = createFileRoute("/map")({
  head: () => ({
    meta: [{
      title: "Weather map — Atmos"
    }, {
      name: "description",
      content: "Interactive weather map of Goa with temperature, precipitation, and wind layers."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./learn-DNLt0TXD.mjs");
const Route$5 = createFileRoute("/learn")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Understand the Air Quality Index, the health effects of each pollutant, and tips to reduce your carbon footprint."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./history-D8HUycFL.mjs");
const Route$4 = createFileRoute("/history")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Monthly and yearly air quality trends, seasonal patterns and year-over-year comparisons."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./community-Bsg4oxHM.mjs");
const Route$3 = createFileRoute("/community")({
  head: () => ({
    meta: [{
      title: "Community air quality — Atmos"
    }, {
      name: "description",
      content: "Report local pollution sources and explore citizen-reported environmental issues on the community map."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./alerts-DUvUCoV7.mjs");
const Route$2 = createFileRoute("/alerts")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Set personal AQI thresholds and get notified when pollution rises in your city."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-DS1Ygjyk.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Real-time AQI hotspots around the world. Search any city for detailed pollutant, weather and environmental insights."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./city._name-BRnpKXo-.mjs");
const Route2 = createFileRoute("/city/$name")({
  head: ({
    params
  }) => ({
    meta: [{
      ...
      name: "description",
      content: `Live AQI, pollutant readings and weather for ${decodeURIComponent(params.name)}.`
    }]
  }),
...
const CommunityRoute = Route$3.update({
  id: "/community",
  path: "/community",
  getParentRoute: () => Route$8
});
...
const CityNameRoute = Route2.update({
  id: "/city/$name",
  path: "/city/$name",
  getParentRoute: () => Route$8
});
